...
int main(int argc, char* argv[]) {
    ...
    while (keep_looping){
        ...
        switch(operation) {
            ...
            case lgSigmoid:
                sz = proxy->ReadInt();
                Sigmoid(proxy, nullptr, sz);
                break;
            case lgSingleSigmoid:
                Sigmoid(proxy, 0);
                break;
            /* case lgfonk:
                sz = proxy->ReadInt();
            ...
            case lgAddNoise:
                sz = proxy->ReadInt();
                size1 = proxy->ReadInt();
                add_noise(proxy, nullptr, sz, size1);
                break;
            case lgAddNoiseMatrix:
                sz = proxy->ReadInt();
                size1 = proxy->ReadInt();
                size2 = proxy->ReadInt();
                add_noise(proxy, nullptr, sz, size1, size2);
                break;
            /* case lgAddNoiseNew:
                size1 = proxy->ReadInt();
                size2 = proxy->ReadInt();
                add_noise_new(proxy, 0, size1, size2);
                break;
            case lgMin:
                sz = proxy->ReadInt();
                Min(proxy, nullptr, nullptr, sz);
                break;
            case lgMax:
                sz = proxy->ReadInt();
                Max(proxy, nullptr, nullptr, sz);
                break;
            case lgAwesomeSig:
                sz = proxy->ReadInt();
                awesome_sig(proxy, nullptr, sz);
                break; */
            case lgGradient:
                size1 = proxy->ReadInt();
                size2 = proxy->ReadInt();
                GradientDescent(proxy, nullptr, nullptr, nullptr, size1, size2, 0, 0, 0);
                break;
            case lgGradientTurkmen:
                size1 = proxy->ReadInt();
                size2 = proxy->ReadInt();
                GradientDescent_Turkmen(proxy, nullptr, nullptr, nullptr, size1, size2, 0);
                break;    
            case lgPredict:
                size1 = proxy->ReadInt();
                size2 = proxy->ReadInt();
                Predict(proxy, nullptr, nullptr, size1, size2);
                break;
            case equals:
                size1 = proxy->ReadInt();
                Equals(proxy, nullptr, nullptr, size1);
                break;
